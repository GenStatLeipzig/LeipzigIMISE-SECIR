...
//[[Rcpp::export]]
NumericMatrix solvecovidmodelKI( DoubleVector parval,CharacterVector parnames, int numpar, DoubleVector u0,
                                ...
                                IntegerVector LockUnlock_vec,  int treatpardir)//NumericMatrix subintervals, NumericMatrix subintervals
{
  ...
  /* cout<<"l 34, start, compnames= "<<compnames<<endl;
  cout<<"l 35, start, compind= "<<compind<<endl;  
  cout<<"l 36, start, compnum= "<<compnum<<endl; 
  cout<<"l 37, start, comppar= "<<comppar<<endl;  */
  par00 = assignparams(parval,parnames, numpar, par00); 
  //cout<<"l 39, start, comppar= "<<comppar<<endl; 
  Compl_variables compl_varstart(u0,compartments00,compnames);
  //cout<<"l 41, start"<<endl;
  ...
  //cout<<"l 58, start, comppar= "<<comppar<<endl;
  ...
  // cout<<"l 72, start, comppar= "<<comppar<<endl;
    treat_arr = GenerateTreatStructKIDir(par00, treat_vec,  LockUnlock_vec, num_steps );
  //}
  //cout<<"l75, sim_arr(0,0) = "<<sim_arr(0,0)<<", param_.r1,2 = "<<  par00.r1<<", "<<par00.r2<<", treat_arr= "<<treat_arr(0,0)<<","<<treat_arr(0,1)<<", 1:"<<treat_arr(1,0)<<","<<treat_arr(1,1)<<endl;
