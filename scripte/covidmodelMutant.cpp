...
//[[Rcpp::export]]
//////////////////////////constructparamscomp:
  DoubleVector covidmodelMutant(DoubleVector u, integral_par param_, compl_compartments compartments, CharacterVector compnames, Compl_variables compl_varstart)  
{
